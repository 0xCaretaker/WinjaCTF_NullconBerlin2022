...
public:
  void scene(scene_t s) {
    ...
    case scene_banner:
      ...
      break;
    case scene_rain:
      this->s3rain(250, buffer::s3rain_scroll_func_tanh);
      break;
    case scene_conway:
      this->s4conway();
      break;
...
int main(int argc, char** argv) {
  ...
  if (args.messages.size()) {
    ...
    buff.s2banner_add_message("Caretaker");
    buff.s2banner_add_message("Let's get");
    buff.s2banner_add_message("FLASHY");
